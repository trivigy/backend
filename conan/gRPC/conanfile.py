...
class gRPCConan(ConanFile):
    ...
    license = "Apache-2.0"
    requires = "zlib/1.2.11@conan/stable", "OpenSSL/1.0.2o@conan/stable", "Protobuf/3.5.2@syncaide/stable", "gflags/2.2.1@bincrafters/stable", "c-ares/1.14.0@inexorgame/stable", "benchmark/1.3.0@inexorgame/stable"
    ...
    default_options = "shared=False", "enable_mobile=False", "non_cpp_plugins=False"
    generators = "cmake"
